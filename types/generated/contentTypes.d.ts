...
export interface ApiMedicineMedicine extends Schema.CollectionType {
  ...
  attributes: {
    medicine_name: Attribute.String & Attribute.Required;
    medicine_desc: Attribute.Text & Attribute.Required;
    is_prescription: Attribute.Boolean & Attribute.Required;
    medicine_img: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    medicine_type: Attribute.Enumeration<
      ['tablet', 'capsule', 'syrup', 'injectables', 'inhalers', 'drops']
    >;
    batch: Attribute.Component<'batch.batch', true>;
    medicine_category: Attribute.Relation<
...
export interface ApiMedicineCategoryMedicineCategory
  ...
  attributes: {
    CategoryName: Attribute.String & Attribute.Unique;
    Description: Attribute.Text;
    StorageRequirements: Attribute.String;
    RequiresPrescription: Attribute.Boolean;
    ControlledSubstance: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPurchaseOrderPurchaseOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    PaymentStatus: Attribute.Enumeration<['Pending', 'Paid', 'Cancelled']>;
...
export interface ApiPurchaseOrderLinePurchaseOrderLine
  ...
  attributes: {
    QuantityOrdered: Attribute.Integer;
    UnitPriceAtOrder: Attribute.Decimal;
    LineTotal: Attribute.Decimal;
    ReceivedStatus: Attribute.Enumeration<['Pending', 'Partial', 'Received']>;
    purchase_order: Attribute.Relation<
      'api::purchase-order-line.purchase-order-line',
      'oneToOne',
      'api::purchase-order.purchase-order'
    >;
    medicine: Attribute.Relation<
      'api::purchase-order-line.purchase-order-line',
      'oneToOne',
      'api::medicine.medicine'
    >;
...
export interface ApiStockInventoryStockInventory extends Schema.CollectionType {
  collectionName: 'stock_inventories';
  info: {
    singularName: 'stock-inventory';
    pluralName: 'stock-inventories';
    displayName: 'StockInventory';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    QuantityOnHand: Attribute.Integer;
    ExpiryDate: Attribute.Date;
    StorageLocation: Attribute.String;
    LastRestockDate: Attribute.Date;
    medicine: Attribute.Relation<
